...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    # 创建因子列
    df[f'DzcciUpper_{n}'] = scale_01(signal, n)
    factor_col = df[f'DzcciUpper_{n}']
