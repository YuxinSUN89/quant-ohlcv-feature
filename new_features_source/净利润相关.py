...
fin_cols = ['R_np@xbx_单季', 'R_np@xbx_ttm', 'R_np@xbx_ttm同比', 'R_np@xbx_累计同比', 'R_np@xbx_单季同比',  'R_np@xbx_单季环比']  # 财务因子列，配置后系统会自动加载对应的财务数据
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    """    
    ----->>>  配置方法  <<<-----
    配置：('净利润相关', is_sort_asc, param, arg)
    含义： 各类净利润相关的因子
    示例：'factor_list': [
                            ('净利润相关', True, '全年', 1),              # 净利润_全年
                            ('净利润相关', True, '全年同比', 1),           # 净利润_全年同比
                            ('净利润相关', True, '累计同比', 1),           # 净利润_累计同比
                            ('净利润相关', True, '单季', 1),              # 净利润_单季
                            ('净利润相关', True, '单季同比', 1),           # 净利润_单季同比     
                            ('净利润相关', True, '单季环比', 1),           # 净利润_单季环比                   
                            ('净利润相关', True, '全年同比季度增加', 1),     # 净利润_全年同比增速季度增加
                            ('净利润相关', True, '累计同比季度增加', 1),     # 净利润_累计同比增速季度增加
                            ('净利润相关', True, '单季同比季度增加', 1),     # 净利润_单季同比增速季度增加
                            ('净利润相关', True, '单季环比季度增加', 1),     # 净利润_单季环比增速季度增加     
                        ]
    """
    # ======================== 参数处理 ===========================
    ...
    # 净利润相关字段说明
    # - R_np@xbx_ttm:净利润ttm
    # - R_np@xbx_ttm同比:净利润ttm同比
    # - R_np@xbx_累计同比:净利润累计同比
    # - R_np@xbx_单季:净利润单季度
    # - R_np@xbx_单季同比:净利润单季度同比
    # - R_np@xbx_单季环比:净利润单季度环比
    param1_cols = {
        '全年': 'R_np@xbx_ttm',
        '全年同比': 'R_np@xbx_ttm同比',
        '累计同比': 'R_np@xbx_累计同比',
    ...
    param2_cols = {
        '全年同比季度增加': 'R_np@xbx_ttm同比',
        '累计同比季度增加': 'R_np@xbx_累计同比',
        '单季同比季度增加': 'R_np@xbx_单季同比',
        '单季环比季度增加': 'R_np@xbx_单季环比',
    }
