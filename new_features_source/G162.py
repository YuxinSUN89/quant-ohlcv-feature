...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    df.drop(['diff', 'max_diff', 'abs_diff', 'ratio', 'part1', 'part2'], axis=1, inplace=True)
    # ========== 原始计算逻辑结束 ==========
    # 创建因子列
    factor_col = df['G162']
    # 创建包含指定因子的DataFrame
