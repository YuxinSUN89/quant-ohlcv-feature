...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    """    
    ----->>>  配置方法  <<<-----
    配置：('G85', is_sort_asc, n, arg)
    含义：G85 = TSRANK((VOLUME / MEAN(VOLUME,20)), 20) * TSRANK((-1 * DELTA(CLOSE, 7)), 8)
    示例：'factor_list': [
                            ('G85', True, '', 1),         # G85
                        ]
    """
