...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    含义：此处AdtmV2_n取ADTM_V2的n日百分位，n缺省值为20，ADTM_V2较ADTM更换了表达方式。
    示例：'factor_list': [  
                            ('AdtmV2', True, '', 1),       # AdtmV2_20    
                            ('AdtmV2', True, 10, 1),       # AdtmV2_10    
                        ]
    """
    # 从额外参数中获取因子名称
    ...
    # 创建因子列
    df[f'AdtmV2_{n}'] = scale_01(signal, n)
    factor_col = df[f'AdtmV2_{n}']
