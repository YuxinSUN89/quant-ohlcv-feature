...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    """    
    ----->>>  配置方法  <<<-----
    配置：('G93', is_sort_asc, n, arg)
    含义：G93 = SUM((OPEN>=DELAY(OPEN,1)?0:MAX((OPEN-LOW),(OPEN-DELAY(OPEN,1)))),20)
    示例：'factor_list': [
                            ('G93', True, '', 1),         # G93
                        ]
    """
