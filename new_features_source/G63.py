...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> pd.DataFrame:
    ...
    """    
    ----->>>  配置方法  <<<-----
    配置：('G63', is_sort_asc, n, arg)
    含义：G63 = SMA(MAX(CLOSE-DELAY(CLOSE,1),0),6,1)/SMA(ABS(CLOSE-DELAY(CLOSE,1)),6,1)*100
    示例：'factor_list': [
                            ('G63', True, '', 1),         # G63
                        ]
    """
